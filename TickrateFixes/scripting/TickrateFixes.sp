...
//float g_ddDoors[2048][DoorsData];
...
{
	name = "Tickrate Fixes",
	author = "Sir, Griffin, Harry Potter",
...
public void OnPluginStart()
{
    ...
    // Slow Doors
    hCvarDoorSpeed     = CreateConVar("tick_door_speed",        "1.3", "Sets the speed of all prop_door entities on a map. 1.05 means = 105% speed", FCVAR_NOTIFY);
    ...
    if (g_hCvarGravity.IntValue != 750) g_hCvarGravity.SetInt(750);
...
public void Hook_OnPostThinkPost(int client)
{
    ...
    {
        // PrintToChatAll("Readjusting delay: Old=%f, int =%f", old_value, new_value);
