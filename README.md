...
* <b>[physics_object_pushfix](/physics_object_pushfix)</b>: Prevents firework crates, gascans, oxygen, propane tanks being pushed when players walk into them
    * 修復玩家走路就能推擠地上物品
...
* <b>[l4d2_weapon_csgo_reload](/l4d2_weapon_csgo_reload)</b>: (CSGO or CS2 Reload Mechanism) Modern weapon reload + Abandon magazine when reload in L4D1/2
