...
public void OnPluginStart()
{
	...
	g_hSpecAfkMsgEnable 	= CreateConVar("l4d_specafk_join_hint_msg", 		"1", "If 1, Display \"You're spectating. Join any team to play.\" message to afk spectator", FCVAR_NOTIFY, true, 0.0, true, 1.0);
